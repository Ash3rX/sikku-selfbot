...
sikkujod = int(config("userid"))
AUTHORIZED_USERS = [sikkujod]  
...
async def status(ctx, activity_type, *, text):
    ...
    if activity_type == 'playing':
        ...
        activity = discord.Streaming(name=text, url='https://www.twitch.tv/sikku')
...
async def help(ctx):
    ...
    response = "**S I K K U  S 3 L F  B O T 1.0.5**\n\n"
...
async def selfbot(ctx):
    ...
    github_link = "https://github.com/sikey-dev"
...
async def on_ready():
    ...
    print(f'{Fore.YELLOW}Dev: notsikey{Style.RESET_ALL}')
    print(f'{Fore.CYAN}Version: 1.0.5{Style.RESET_ALL}')
    print(f'{Fore.MAGENTA}Github: https://github.com/sikey-dev{Style.RESET_ALL}')
